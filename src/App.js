          ...
          <header className="App-header" id="header">
            ...
            <div className="row">
              <div className="col-8" >
                ...
                <input type="number" className="form-control" style={{ borderRadius: '1em' }} onChange={(e) => this.setState({ num: e.target.value })} value={this.state.num} placeholder="Elect usage"/>
              </div>
              <div className="col-4" >

                <button type="button" className="btn btn-primary" onClick={() => { this.save() }} ><FaSave /> Save</button>
              </div>
            </div>
